...
export class MSC_MemberClubConstruct extends Construct {
    constructor(scope: Construct, id: string, props: MSC_MemberClubConstructProps) {
        ...
        const get_payment_details = new MSC_Lambda(this, `${id}-GetPaymentDetails`, {
            code: "member/club/get_payment_details",
            envVariables: {
                CLUB_TABLE_NAME: props.club_table.tableName,
            },
            permissions: {
        ...
        const get_payment_details_resource = club_resource.addResource("getPaymentDetails");
        ...
        addCorsEnabledMethod(get_payment_details_resource, get_payment_details, { methodResponses: [] }, undefined, "GET");
    }
}
