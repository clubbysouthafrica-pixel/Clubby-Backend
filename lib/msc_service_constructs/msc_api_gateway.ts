...
export class MSC_APIGateway extends RestApi {
    constructor(scope: Construct, id: string, props: MSC_APIGatewayProps) {
        ...
        const domain_name = `${(process.env.ENVIRONMENT as string).toLowerCase()}.${props.domain}.${(process.env.DOMAIN as string)}`;
        ...
        this.addGatewayResponse('UnauthorizedResponse', {
            ...
            responseHeaders: {
                'Access-Control-Allow-Origin': "'https://beta.clubby.co.za'",
