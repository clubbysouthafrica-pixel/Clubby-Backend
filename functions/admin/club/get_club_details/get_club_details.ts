...
export const handler = async (event: any) => {
    ...
    try {
        ...
        return createResponse(200, {
            ...
            registration_submission_email_subject: item?.registration_submission_email_subject,
            registration_success_email_template_body: item?.registration_success_email_template_body,
            registration_success_email_subject: item?.registration_success_email_subject,
