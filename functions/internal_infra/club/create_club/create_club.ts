...
const EMAIL_TEMPLATE = {
    "registration_submission_email_template_body": `<p>Hi {{member_name}},</p><p><br></p><p>Thank you for submitting your registration to <strong>{{clubName}}</strong>! 🎉</p><p><br></p><p>We’ve received your details and are excited that you’re interested in becoming a member.</p><p><br></p><p><strong>Next Steps to Complete Your Membership:</strong></p><ol><li data-list="ordered"><span class="ql-ui" contenteditable="false"></span><strong>💳 Perform the membership payment: </strong>You can make your payment via EFT. (Make sure to include your unique Clubby reference number as a payment reference. This can be found in your member account.)</li></ol><p><br></p><p>After we verify your payment and confirmation, you’ll officially become a registered member — welcome aboard!</p><p><br></p><p>If you have any questions, please contact us at <a href="mailto:{{clubEmail}}" rel="noopener noreferrer" target="_blank">{{clubEmail}}</a>.</p><p><br></p><p>Warm regards,</p><p><strong>The {{clubName}} Team</strong></p>`,
    "registration_success_email_template_body": `<p>Hi {{member_name}},</p><p><br></p><p>🎉 Congratulations and welcome to <strong>{{clubName}}</strong>!</p><p><br></p><p>Your registration has been successfully completed, and you are now an official member of our club.</p><p><br></p><p><strong>What’s Next:</strong></p><ul><li>✅ You now have full access to member benefits and upcoming events.</li><li>💬 Stay tuned for updates and communications from the <strong>{{clubName}}</strong> team.</li></ul><p><br></p><p>If you have any questions or need assistance, please reach out to us at <a href="mailto:{{clubEmail}}" rel="noopener noreferrer" target="_blank">{{clubEmail}}</a>.</p><p><br></p><p>We’re thrilled to have you as part of our community!</p><p><br></p><p>Warm regards,</p><p><strong>The {{clubName}} Team</strong></p>`,
}
...
export const handler = async (event: any) => {
    ...
    try {
        ...
        EMAIL_TEMPLATE.registration_submission_email_template_body
            .replace(/{{clubName}}/g, body.club_name)
            .replace(/{{clubEmail}}/g, body.support_email)
